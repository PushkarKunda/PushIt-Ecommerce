...
import ProductDetailsDialog from "@/components/shopping/products-details";
...
function ShoppingHome() {
  ...
  function handleNavigateToListingPage(getCurrentItem, section) {
    ...
    let currentItemFilter = [getCurrentItem.id];
    ...
    if (section === "category") {
      ...
      if (categoryMapping[getCurrentItem.id]) {
        currentItemFilter = categoryMapping[getCurrentItem.id];
      }
    }

    const currentFilter = {
      [section]: currentItemFilter,
    };
